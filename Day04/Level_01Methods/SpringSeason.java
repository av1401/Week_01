//program to check whether a month is in spring season or not 
import java.util.*;
public class SpringSeason{
	...
	public static boolean springSeason(int month,int day){
		...
		if((month == 4 || month == 5) && (day >=1 && day <= 30)){
			springSea = true;
		}
	...
	public static void main(String args[]){
		...
		//Calling method
		if(springSeason(month,day)) System.out.println("Its a Spring season");
