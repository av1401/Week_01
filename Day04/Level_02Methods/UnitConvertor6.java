//program for different unit conversions
import java.util.*;
public class UnitConvertor6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n" + fahrenheit + " Fahrenheit is equal to " + convertFahrenheitToCelsius(fahrenheit) + " Celsius");
        ...
        System.out.println("\n" +pounds + " pounds is equal to " + convertPoundsToKilograms(pounds) + " kilograms");
        ...
        System.out.println("\n" +gallons + " gallons is equal to " + convertGallonsToLiters(gallons) + " liters");
